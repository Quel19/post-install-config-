...
- If you need help installing osTicket, please see my tutorial [here](https://github.com/Quel19/osticket-prereqs)
...
🎉Congratulations! You have set up osTicket succesfully!🎉 Click [here](https://github.com/Quel19/Ticket-Lifecycle-Examples) to move on to the final part of this tutorial!
